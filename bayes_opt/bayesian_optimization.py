...
class BayesianOptimization(Observable):
    ...
    """
    def __init__(self, model, f, pbounds, random_state=None, verbose=2,
                 bounds_transformer=None, n_warmup=10000):
    ...
    def suggest(self, utility_function, topk=1):
        ...
        with warnings.catch_warnings():
            ...
            self._model.fit(self._space.params, self._space.target)
        
        # Finding argmax of the acquisition function.
        suggestion = acq_max(
            ac=utility_function.utility,
            gp=self._model,
            y_max=np.max(self._space.target),
