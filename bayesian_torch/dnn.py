...
import bayesian_torch.models.deterministic.simple_fc as simple_fc
from bayesian_torch.dataset import Dataset, Dataset_T

class DNN:
    def __init__(self, input_dim, output_dim=1, batch_size=32, lr=1.0, gamma=0.99, activation=F.relu, seed=1,):
